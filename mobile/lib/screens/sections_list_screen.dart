...
final sectionSearchQueryProvider = StateProvider.autoDispose<String>(
  (ref) => '',
);
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      child: TextField(
                        onChanged: (value) {
                          ref.read(sectionSearchQueryProvider.notifier).state =
                              value;
                        },
                ...
                child: sectionsAsync.when(
                  data: (sections) {
                    final searchQuery = ref
                        .watch(sectionSearchQueryProvider)
                        .toLowerCase();
                    final filteredSections = searchQuery.isEmpty
                        ? sections
                        : sections.where((section) {
                            return section.sectionNumber.toLowerCase().contains(
                                  searchQuery,
                                ) ||
                                section.heading.toLowerCase().contains(
                                  searchQuery,
                                ) ||
                                (section.preview?.toLowerCase().contains(
                                      searchQuery,
                                    ) ??
                                    false);
                          }).toList();
